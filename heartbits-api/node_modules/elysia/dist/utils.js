...
var import_file = require('./universal/file.js'), import_utils = require('./universal/utils.js');
...
}, hasHeaderShorthand = import_utils.isBun ? "toJSON" in new Headers() : !1, hasSetImmediate = typeof setImmediate == "function", checksum = (s) => {
  let h = 9;
...
const fnToContainer = (fn, subType) => {
  ...
  return formData;
}, randomId = typeof crypto > "u" || (0, import_utils.isCloudflareWorker)() ? () => {
  let result = "";
