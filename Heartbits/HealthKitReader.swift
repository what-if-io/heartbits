...
// ── HealthKitReader (iOS) ─────────────────────────────────────────────────────
//
// Reads heart rate from the shared HealthKit store (synced from Apple Watch).
// Identical query approach to the watch target — HKAnchoredObjectQuery with
// an updateHandler for live delivery as new samples arrive from the watch.
