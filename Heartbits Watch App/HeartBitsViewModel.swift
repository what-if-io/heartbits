...
public final class HeartBitsViewModel {
    ...
    public func didReceiveHeartRate(_ bpm: Double) async {
        ...
        WatchBridge.shared.sendHeartRate(bpm)
    ...
    public func startSending() async {
        ...
        // Subscribe to incoming beats immediately — don't wait for ReceiverView to appear
    ...
    public func didReceivePartnerBeat(bpm: Double, rrIntervalMs: Double) {
        let heartBit = HeartBit(
            senderAddress: recipientAddress,
            recipientAddress: senderAddress,
            bpm: bpm,
            rrIntervalMs: rrIntervalMs
        )
        didReceiveHeartBit(heartBit)
    }
