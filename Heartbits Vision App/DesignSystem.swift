...
// ── HeartBits Design System ───────────────────────────────────────────────────
//
// Every visual token in one place. Change here, changes everywhere.

extension Color {
    static let hbBackground = Color(red: 0.027, green: 0.027, blue: 0.063)
    static let hbCoral      = Color(red: 1.00,  green: 0.42,  blue: 0.42)   // #FF6B6B
    static let hbPurple     = Color(red: 0.48,  green: 0.21,  blue: 0.87)   // #7B35DE
    static let hbMagenta    = Color(red: 0.91,  green: 0.12,  blue: 0.55)   // midpoint
}
...
// ── Gradient ECG waveform — iOS-specific (gradient stroke, thicker, bigger) ──
